...
/// <summary>
/// TODO: Copied from the event add component
/// </summary>
public sealed class EventEditViewModel : NotificationObject
{
...
#pragma warning restore CA1822 // Пометьте члены как статические
    ...
    public EventEditViewModel(int eventId, EventService eventService)
    {
